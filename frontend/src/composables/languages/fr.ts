export default {
  ...
  gameSessions: {
    ...
    modeChallengeDesc: 'Tous les joueurs répondent simultanément avec un minuteur (style Kahoot)',
    ...
    selectQuestionnaireLabel: 'Sélectionner un questionnaire *',
    loadingQuestionnaires: 'Chargement des questionnaires...',
    noQuestionnaires: "Vous n'avez pas de questionnaires créés.",
    createQuestionnaire: 'Créer un questionnaire',
    editTitle: 'Modifier la session',
    newTitle: 'Nouvelle session de jeu',
    sessionInfoTitle: 'Informations sur la session',
    statusLabel: 'Statut :',
    questionsLabel: 'Questions :',
    refreshHint: "Vous pouvez mettre à jour les questions du questionnaire s'il a été modifié.",
    refreshing: 'Mise à jour...',
    refreshQuestions: 'Mettre à jour les questions',
    questionsInSession: 'Questions dans cette session :',
    pts: 'pts',
    ...
    confirmations: {
      ...
      refresh: 'Mettre à jour les questions de cette session ?',
    },
    alerts: {
      ...
      noPermission: "Vous n'avez pas la permission de voir cette session",
      refreshError: 'Erreur lors de la mise à jour des questions',
      questionsUpdated: '{count} questions mises à jour',
      createError: 'Erreur lors de la création de la session de jeu',
    },
  },
  // PlayGameView
  play: {
  ...
  challenge: {
    lobby: {
      title: 'Challenge',
      waitingForHost: "En attente du début du challenge par l'hôte...",
      players: 'Joueurs dans le lobby',
    ...
    result: {
      ...
      scoreboard: 'Scores',
      waitingForNext: 'En attente de la prochaine question...',
    },
    finished: {
      title: 'Challenge terminé !',
      subtitle: 'Le défi est terminé. Voyez comment vous vous en êtes sorti !',
      viewRanking: 'Voir le classement final',
    },
    panel: {
      title: 'Panneau du challenge',
      notInitialized: "Le challenge n'est pas encore initialisé. Cliquez pour initialiser.",
      initialize: 'Initialiser le challenge',
      startFirstQuestion: 'Démarrer la première question',
      showResult: 'Afficher les résultats',
      nextQuestion: 'Question suivante',
      finish: 'Terminer le challenge',
      answered: 'ont répondu',
      status: {
        waiting: 'En attente',
        playing: 'En jeu',
        showing_result: 'Résultat affiché',
        finished: 'Terminé',
      },
      errors: {
        initError: "Erreur lors de l'initialisation du challenge",
        playError: 'Erreur lors du passage à la question suivante',
        showResultError: "Erreur lors de l'affichage des résultats",
        finishError: 'Erreur lors de la fin du challenge',
      },
    },
  },
};
