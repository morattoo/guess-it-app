export default {
  ...
  gameSessions: {
    ...
    modeChallengeDesc: 'All players answer simultaneously with a timer (Kahoot-style)',
    ...
    selectQuestionnaireLabel: 'Select a Questionnaire *',
    loadingQuestionnaires: 'Loading questionnaires...',
    noQuestionnaires: 'You have no questionnaires created.',
    createQuestionnaire: 'Create a questionnaire',
    editTitle: 'Edit Session',
    newTitle: 'New Game Session',
    sessionInfoTitle: 'Session Information',
    statusLabel: 'Status:',
    questionsLabel: 'Questions:',
    refreshHint: 'You can update the questionnaire questions if it has been modified.',
    refreshing: 'Updating...',
    refreshQuestions: 'Update Questions',
    ...
    confirmations: {
      ...
      refresh: 'Update the questions for this session?',
    },
    alerts: {
      ...
      noPermission: 'You do not have permission to view this session',
      refreshError: 'Error updating questions',
      questionsUpdated: '{count} questions updated',
      createError: 'Error creating game session',
    },
  },
  // PlayGameView
  play: {
    ...
    yourCurrentScore: 'Current score',
    points: 'points',
    progress: 'Progress',
    continue: 'Continue',
    start: 'Start',
  ...
  createQuestion: {
    ...
    typeBoolean: 'True/False Question',
  },
  // Language selector
  language: {
  ...
  challenge: {
    lobby: {
      title: 'Challenge',
      waitingForHost: 'Waiting for the host to start the challenge...',
    ...
    playing: {
      ...
      waitingForOthers: 'Waiting for others to answer...',
      timeUp: 'Time is up!',
    },
    result: {
      correct: 'Correct!',
    ...
    finished: {
      ...
      subtitle: 'The challenge is over. See how you did!',
      viewRanking: 'View final ranking',
    },
    panel: {
      title: 'Challenge panel',
      notInitialized: 'Challenge not initialized yet. Click to initialize.',
      ...
      errors: {
        initError: 'Error initializing challenge',
        playError: 'Error advancing question',
        showResultError: 'Error showing results',
        finishError: 'Error finishing challenge',
      },
    },
  },
};
